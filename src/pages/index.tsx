  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless communication with Test - a chat application supporting one-on-one and group conversations, enriched with emojis, image sharing, and video sharing capabilities."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-8707de31f9c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0JTIwYXBwbGljYXRpb258ZW58MHx8fHwxNjk1NjEyNjUwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless communication with Test - a chat application supporting one-on-one and group conversations, enriched with emojis, image sharing, and video sharing capabilities.`}
            </Text>
            <Box
