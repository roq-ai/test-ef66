...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create.create': { roles: ['owner', 'admin', 'team-member'], key: 'task', tenantPath: [], userPath: [] },
  'project.update.update': { roles: ['owner', 'admin', 'team-member'], key: 'project', tenantPath: [], userPath: [] },
  'invoice.delete.delete': { roles: ['owner'], key: 'invoice', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'admin', 'team-member'];
